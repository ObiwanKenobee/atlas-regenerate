        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
          {stakeholders.map((stakeholder, index) => (
            <div
              ...
              className="group relative glass rounded-2xl p-8 hover:border-earth/30 transition-all duration-500 overflow-hidden"
            >
              {/* Background Glow */}
              ...
              {/* CTA */}
              <button className="inline-flex items-center gap-2 text-earth hover:text-gold transition-colors duration-300 text-sm font-medium relative z-10 group/btn">
                {stakeholder.cta}
